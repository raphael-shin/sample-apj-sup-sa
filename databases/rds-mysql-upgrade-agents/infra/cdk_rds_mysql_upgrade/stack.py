"""MySQL Upgrade multi-agent stack.
...
#   deploy/
#     infra/cdk_rds_mysql_upgrade/stack.py   (this file — parents[2] = deploy/)
#     agents/
...
class RdsMysqlUpgradeAgentStack(Stack):
    def __init__(
        self,
        scope: Construct,
        construct_id: str,
        ...
        **kwargs,
        ...
        runtime_role = iam.Role(
            ...
            description="Execution role for MySQL upgrade agents on Bedrock AgentCore",
        )
        for managed in (
