...
# MySQL Upgrade Readiness Checker — Streamlit UI (옵셔널)
...
2. `./.env` — 이 UI 전용 값 (주로 CDK 가 만들어낸 4개 ARN)
...
- **사이드바 리포트** — 분석 완료 후 `.md` 리포트 3종 다운로드
