...
if REPORT_LANGUAGE not in ("ko", "en"):
    REPORT_LANGUAGE = "ko"
_REPORTS_BUCKET_BASE = os.getenv("REPORTS_BUCKET_NAME", "rds-mysql-upgrade-reports")
...
# --- i18n -------------------------------------------------------------------
# All user-facing UI strings, keyed by language. The same REPORT_LANGUAGE that
# is sent to the agents drives the UI language too. {placeholders} are filled by
# t() via str.format.
STRINGS = {
    "ko": {
        "lang_name": "한국어",
        ...
        "page_caption": "MySQL 8.0.x → 8.4.x 업그레이드 준비 상태를 분석합니다.",
        "btn_run": "🚀 분석 시작",
        "btn_clear": "🗑️ 출력 지우기",
    ...
    "en": {
        ...
        "page_caption": "Analyzes MySQL 8.0.x → 8.4.x upgrade readiness.",
...
def main() -> None:
    ...
    st.title("🔍 MySQL Upgrade Readiness Checker")
